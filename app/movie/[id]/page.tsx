"use client";                               import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
...
if (!params || !params.id) {
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center">
      <p className="text-2xl text-red-500">Invalid movie ID.</p>
    </div>
  );
}
  ...
  try {
    ...
    return (
      <div className="min-h-screen bg-gray-900 text-white flex items-center justify-center">
        <p className="text-2xl text-red-500">Failed to load movie details. Please try again later.</p>
      </div>
    );
  }
